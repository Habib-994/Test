...
<meta name="description" content="Designs Bulls are an innovative Design agency with admirable design services within minimum time.Share your idea with us and discuss your project now!">
      ...
      <section class="pricing-page pricing-main-sec">
         <div class="wrapv">
         ...
         <div class="container">
            ...
            <div class="pricing-tabs-box">
               <nav class="nav nav-pills" role="tablist">
                  ...
                  <a class="nav-item nav-link <?= $index == 0 ? 'active' : '' ?>" data-toggle="tab" href="#nav-<?= $categoryPackage['id'] ?>"><?= $categoryPackage['name'] ?></a>
                  <?php } ?>
               </nav>
            </div>
            <div class="pricing-tab-cont-box">
               <div class="tab-content">
                  <?php foreach ($categoriesPackages as $index => $categoryPackage) { ?>
                  <div class="tab-pane fade <?= $index == 0 ? 'active show' : '' ?>" id="nav-<?= $categoryPackage['id'] ?>">
                     ...
                     <div class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                           <?= generatePackageBox('package_box_second_revamp',$package) ?>
                        </div>
                        <?php } ?>
                        <?php } ?>
                        <?php } ?>
