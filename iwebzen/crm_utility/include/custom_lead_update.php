...
$headers = "From: Brand.com <do-not-reply@brand.com>";
...
// Create obj
$obj = new Utility();
$custom_data = $obj->save_lead_init($leadApiData, $email_data, $_POST['package']);
//var_dump($custom_data);
$list = json_decode($custom_data,1);
//var_dump($list);
//$custom_lead_id = $obj->save_lead_init($leadApiData, $email_data);
